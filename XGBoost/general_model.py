...
class general_model:
    ...
    def load_data(self, arbiter_num, xor_num, feedforward_num, lightweight_num, interpose_num):
        ...
        for a in range(arbiter_num):
            ...
            arbiter_data, arbiter_data_label = arbiter_puf.load_data(68, 300, random_seed[a], random_num[a])
        ...
        for x in range(xor_num):
            ...
            #print("xx")
            xor_puf = XOR_PUF()
            xor_data, xor_data_label = xor_puf.load_data(68, 300, 4, random_seed1[x], random_seed2[x], 
        ...
        for f in range(feedforward_num):
            ...
            ff_data, ff_data_label = ff_puf.load_data(68, 300, 4, 32, 60, random_seed1[f], random_seed2[f], 
