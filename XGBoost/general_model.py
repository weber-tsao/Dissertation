...
class general_model:
    ...
    def load_data(self, arbiter_num, xor_num, feedforward_num, lightweight_num, interpose_num):
        ...
        for a in range(arbiter_num):
            ...
            arbiter_data, arbiter_data_label = arbiter_puf.load_data(68, 50000, random_seed, random_num)
        ...
        for x in range(xor_num):
            random_num = random.randint(1,1000)
            random_xor_num = [4,6,4,5,3,6]#[6,5,4,3,2,6]
        ...
        for f in range(feedforward_num):
            ...
            ff_data, ff_data_label = ff_puf.load_data(68, 50000, random_xor_num[f], f1, f2, random_seed1[f], random_seed2[f], 
