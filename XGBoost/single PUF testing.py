...
# XOR Arbiter PUF
xor_puf = XOR_PUF()
data, data_label, attack_data = xor_puf.load_data(68, 5000, 3, 13,256,22,77,89,90, 11, 0)
...
attack = LRAttack2021(crp, seed=3, k=3, bs=1000, lr=.001, epochs=100)
...
# XOR Arbiter PUF
new_data, new_data_label, new_attack_data= xor_puf.load_data_2021(68, 5000, 3, 13,256,22,77,89,90, 11, 
                                                                  0, array)
data, data_unseen, data_label, data_label_unseen = train_test_split(data, data_label, test_size=.20)
