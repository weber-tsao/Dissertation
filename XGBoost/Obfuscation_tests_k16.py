...
xor_apuf = XORArbiterPUF(n=16, k=3, seed=1)
ff_apuf = XORFeedForwardArbiterPUF(n=16, k=3, ff=[(4, 8)], seed=1)
...
apuf_crps = pypuf.io.ChallengeResponseSet.from_simulation(apuf, N=5000, seed=2)
xor_apuf_crps = pypuf.io.ChallengeResponseSet.from_simulation(xor_apuf, N=50000, seed=2)
ff_apuf_crps = pypuf.io.ChallengeResponseSet.from_simulation(ff_apuf, N=50000, seed=2)
...
c_origin_list = ['16_stage_APUF_C_Origin.txt', '16_stage_3XOR_APUF_C_Origin.txt', '16_stage_3XOR_FFPUF_C_Origin.txt']
r_final_list = ['APUF0utput_OWF_w_12_epsilon_a_pat_0_output_K_16.txt', '3XORAPUF0utput_all_w_12_epsilon_a_pat_0_output_K_16.txt', '3XOR_FF_PUF0utput_all_w_12_epsilon_a_pat_0_output_K_16.txt']



apuf = ArbiterPUF(n=16, seed=1)
xor_apuf = XORArbiterPUF(n=16, k=3, seed=2)
ff_apuf = XORFeedForwardArbiterPUF(n=16, k=3, ff=[(4, 8)], seed=1)
