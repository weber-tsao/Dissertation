...
and graph attention neural network(so-called GAT) were used. 

\subsection{SARSALambda Q learning}
The type of reinforcement learning that was implemented is the SARSALambda Q learning \cite{Reference9}. The general idea is that an agent will 
...
\subsubsection{Example of SARSALambda Q learning}
...
\subsubsection{Evaluation of SARSALambda Q learning}
...
\subsection{Graph attention neural network}
...
\subsubsection{Example of Graph attention neural network}
...
\subsubsection{Aggregate operation of Graph attention neural network}
...
\subsubsection{Evaluation of Graph attention neural network}
