...
\subsection{Authentication process: Authentication stage}
...
\section{Different type of PUF: Arbiter PUF and XOR arbiter PUF}
There are many different types of PUF such as arbiter PUF, ring oscillator PUF, lightweight PUF, etc. In this report, arbiter PUF and its mutation will be introduced in detail. 

\subsection{Idea of arbiter PUF}
The general idea of the arbiter PUF is comparing the transition speed for two electrical signals in the PUF's structure(See Figure \ref{fig:figure6}). 
The arbiter PUF's structure contains a number of 
...
\subsection{Idea of XOR arbiter PUF}
...
\section{Potential threat on PUF: Modeling attack}
...
\section{Countermeasure for modeling attack: Reconfigurability}

\subsection{Basic concept of a type of reconfigurability framework: OPUF}
...
\subsection{DPUF: An example of OPUF}
