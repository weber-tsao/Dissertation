...
the agent will travel through different combinations of multiplexers(different challenge) and construct a Q table(See Table \ref{tab:table1}) by collecting rewards on multiplexers. The final goal for the agent is to find the route with 
